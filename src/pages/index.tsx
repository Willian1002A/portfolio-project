    ...
    <div className="Background">
      ...
      <section className="perfil">
          ...
          <div className="socialMedias">
            <LinkA href="https://www.linkedin.com/in/willian-anderson-suriz-d-amico-716b831a8/" className="socialIcon" targetOnNewTab={true}>
            ...
            <LinkA href="https://github.com/Willian1002A" className="socialIcon" targetOnNewTab={true}>
